...
public class CommonsGG extends JPanel {
    ...
    public CommonsGG(BranchGroup sceneBG) {
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(new CommonsGG(createScene()));
    ...
    public static class MyGUI extends JFrame {
        ...
        public MyGUI(BranchGroup branchGroup, String title) {
            ...
            frame.getContentPane().add(new CommonsGG(branchGroup));
            pack();
